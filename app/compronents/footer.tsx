export default function Footer() {
    return (
        <footer className="bg-gradient-to-r from-sky-500 to-blue-600 text-slate-300">
        <div className="max-w-7xl mx-auto px-6 py-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
                <span className="text-2xl font-bold text-white">YourLogo</span>
                <p className="mt-4 text-sm text-slate-50">Xxx</p>
            </div>
            ...
            <div>
                ...
                <button type="submit" className="flex-none rounded-md bg-pink-500 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-500 transition">Xxx</button>
                </form>
            </div>
            </div>

            <div className="mt-12 border-t border-slate-800 pt-8 flex flex-col sm:flex-row items-center justify-between">
            <p className="text-xs text-slate-50">&copy; 2026 Your Company, Inc. All rights reserved.</p>
            <div className="flex space-x-6 mt-4 sm:mt-0">
                <a href="#" className="text-slate-50 hover:text-white">Facebook icon</a>
                <a href="#" className="text-slate-50 hover:text-white">Instagram icon</a>
                <a href="#" className="text-slate-50 hover:text-white">Tiktok icon</a>
                <a href="#" className="text-slate-50 hover:text-white">Twitter icon</a>
            </div>
            </div>
        </div>
        </footer>
